...
module.exports = {
  ...
  buildMutation: function (collection) {
    ...
    _.forEach(collectionAttributes, function (rules, key) {
      ...
      args.required[key] = {
        type: rules.required ? new GraphQL.GraphQLNonNull(convertToGraphQLMutationType(rules, self)) : convertToGraphQLMutationType(rules, self)
      };
    });
 ...
 * @return {Object}
 */
function convertToGraphQLMutationType(rules, ctx) {
