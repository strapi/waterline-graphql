...
module.exports = {
  ...
  buildMutation: function (collection) {
    ...
    // Set primary key as required for next mutations
    argPrimaryKey[collection.primaryKey] = {
      type: new GraphQL.GraphQLNonNull(convertToGraphQLType(collectionAttributes[collection.primaryKey]))
    };

    // Update record
    fields['update' + collectionIdentity] = {
      type: this.defaults.types[collectionIdentity],
      args: _.assign(args, argPrimaryKey),
      resolve: function (rootValue, args) {
